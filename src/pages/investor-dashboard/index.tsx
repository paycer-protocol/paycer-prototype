...
import KycProcessInfo from '@components/organisms/investor-dashboard/info'
import KycProcessTimeline from '@components/organisms/investor-dashboard/timeline'
import Transactions from '@components/organisms/investor-dashboard/transactions'
