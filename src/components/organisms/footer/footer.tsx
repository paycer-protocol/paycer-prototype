...
>>>>>>> 7453f9d (PNS-273 Add eslint and eslint config, apply)
            ...
            <div className="col-md-2 mb-6 mb-lg-0 text-center text-lg-start">
              ...
              <ul className="nav nav-tabs d-block border-0">
                <li className="nav-item m-0">
                  <a target="_blank" className="nav-link p-0 pb-4" href="https://www.paycer.io/#anchor-RoadMap" rel="noreferrer">
                    {t`Roadmap`}
                  </a>
                </li>
              </ul>
            ...
            <div className="col-md-2 mb-5 mb-lg-0 text-center text-lg-start">
              ...
              <ul className="nav nav-tabs d-block border-0">
                <li className="nav-item m-0">
                  <a target="_blank" className="nav-link pt-0 pb-4" href="https://paycer.gitbook.io/paycer/" rel="noreferrer">
                    {t`Docs`}
                  </a>
                </li>
                <li className="nav-item m-0">
                  <a target="_blank" className="nav-link pt-0 pb-4" href="https://paycer.gitbook.io/paycer/documentation/whitepaper" rel="noreferrer">
                    {t`Whitepaper`}
                  </a>
                </li>
                <li className="nav-item m-0">
                  <a target="_blank" className="nav-link pt-0 pb-4" href="https://paycer.io/paycer_litepaper.pdf?t=1635467490116" rel="noreferrer">
                    {t`Lightpaper`}
                  </a>
                </li>
              </ul>
          ...
          <div className="border-top border-bottom-0 mt-lg-6 mt-5 pt-4 justify-content-lg-between d-lg-flex">
            ...
            <div className="text-muted text-center text-lg-start mt-4 mt-lg-0">
              &copy; 2022 Paycer &nbsp;&nbsp;|&nbsp;&nbsp;
              {' '}
              <a href="https://www.paycer.io">paycer.io</a>
            </div>
          </div>
        </div>
      </footer>
