    ...
    return (
        <div>
            <div className="d-md-flex justify-content-between">
                ...
                <Styles.Toolbar>
                    <div
                        onClick={async () => await fetchChartData('daily')}
                        className={classnames({ 'is--Active': interval === 'daily' })}
                    >
                        D
                    </div>
                    <div
                        onClick={async () => await fetchChartData('weekly')}
                        className={classnames({ 'is--Active': interval === 'weekly' })}
                    >
                        W
                    </div>
                    <div
                        onClick={async () => await fetchChartData('monthly')}
                        className={classnames({ 'is--Active': interval === 'day' })}
                    >
                        M
                    </div>
                    <div
                        onClick={async () => await fetchChartData('yearly')}
